...
RegisterCommand("carry",function(source, args)
	...
	if exports['qb-policejob']:IsHandcuffed() then
		return QBCore.Functions.Notify("Power Gaming Krta Hai", 'error')
	end
	-- to stop powergaming in the server
	if carry.InProgress then
		...
		if carry.InProgress == false then
			...
			-- drawNativeNotification("~r~Power Gaming!")
